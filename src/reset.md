...
好，这里我直接按你现有风格续写成“可直接粘贴的 Markdown 正文”，语气、结构、颗粒度都对齐你前面的文档，而且区分清楚两种场景，不会把新手绕晕。

下面内容你可以原封不动用，也可以微调措辞。

⸻


## 思科交换机 & 路由器：删除用户数据（无法进入管理视图）
...
在 **[Cisco](chatgpt://generic-entity?number=0)** 设备上：
